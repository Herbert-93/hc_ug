        ...
        <div className="container">
          <div className="objectives-grid">
            <div className="objectives-left reveal-left">
              ...
              <div className="objectives-photo">
                <img
                  src="https://images.unsplash.com/photo-1547826039-a3209da9d515?auto=format&fit=crop&w=700&q=80"
                  alt="African youth smiling together"
                  loading="lazy"
                />
              </div>

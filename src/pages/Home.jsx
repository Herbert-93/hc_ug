          ...
          <div className="mv-grid">
            <div className="mv-visual reveal-left">
              <div className="mv-image-frame">
                <div className="mv-image-content">
                  <div className="mv-quote-mark">"</div>
                  <p className="mv-quote-text">
                    Every young person in Uganda deserves a chance to discover their potential and contribute meaningfully to their community.
                  </p>
                  <div className="mv-quote-attr">— Hope For Communities Uganda</div>
                </div>
                <div className="mv-decorative-circle"></div>
                <div className="mv-decorative-line"></div>
              </div>
            </div>
...
const stats = [
  {
    ...
    desc: 'Young people trained and transformed',
    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75"/></svg>`,
  },
  {
    value: 12, suffix: '',
    label: 'Districts Covered',
    desc: 'Regions across Uganda reached',
  ...
  },
  {
    ...
    desc: 'NGOs, companies and institutions',
    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v16"/></svg>`,
  },
  {
    value: 350, suffix: '+',
    label: 'Youth in Business',
    desc: 'Graduates now running enterprises',
...
const objectives = [
  {
    title: 'Provide Accessible Skills Training',
    desc: 'Offer free and subsidised vocational and life skills training to youth aged 15–35 across Uganda, prioritising underserved communities.',
  },
  {
    title: 'Nurture Talent & Creative Expression',
    desc: 'Create platforms and pipelines for Uganda\'s gifted youth to develop, showcase, and monetise their talents in arts, sports, and innovation.',
  },
  {
    title: 'Promote Civic Awareness & Health',
    desc: 'Conduct regular sensitization on reproductive health, civic rights, environmental responsibility, and anti-corruption among youth.',
  },
  {
    title: 'Foster Youth-Led Entrepreneurship',
    desc: 'Equip young people with business knowledge, seed capital access, mentorship, and networks to start and sustain viable enterprises.',
  },
  {
    title: 'Build Resilient Community Networks',
    desc: 'Strengthen community cohesion by engaging families, local leaders, faith institutions, and government in joint youth development efforts.',
  },
  {
    title: 'Advocate for Youth Policy Change',
    desc: 'Influence national and local government policies to prioritise youth empowerment, education funding, and employment opportunities.',
  },
]
...
const activities = [
  {
    ...
    desc: 'A flagship annual gathering bringing together thousands of young people, leaders, and partners to celebrate achievements and chart the future.',
  ...
  },
  {
    ...
    desc: 'Regular competitions and showcase events where youth present their talents in music, drama, fine art, sports, and innovation to the public.',
    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>`,
  },
  {
    title: 'Community Clean-Up Drives',
    desc: 'Monthly environmental actions that combine youth mobilisation with civic education, making communities cleaner and youth more responsible.',
  ...
  },
  {
    ...
    desc: 'Regular visits to secondary schools and tertiary institutions for career guidance, life skills sessions, and HFCU program enrolment drives.',
  ...
  },
  {
    ...
    desc: 'Free medical check-ups, counselling services, HIV/AIDS testing, and mental health awareness sessions held across districts.',
  ...
  },
  {
    ...
    desc: 'Organised youth sports leagues in football, netball, athletics and indoor games that promote teamwork, discipline, and physical wellness.',
  ...
  },
  {
    ...
    desc: 'Practical workshops on bookkeeping, SACCO management, business planning, and accessing micro-finance to support youth entrepreneurs.',
    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/></svg>`,
  },
  {
    title: 'Digital Skills Bootcamps',
    desc: 'Intensive short courses in computer literacy, social media for business, graphic design, and digital marketing for youth entering the modern workforce.',

...
/* ---- Data ---- */
const programs = [
  { title: 'Youth Vocational Training',      description: 'Hands-on trade and technical skills training in carpentry, tailoring, plumbing, electrical works, and more — giving youth marketable expertise.',                                    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M14.7 6.3a1 1 0 000 1.4l1.6 1.6a1 1 0 001.4 0l3.77-3.77a6 6 0 01-7.94 7.94l-6.91 6.91a2.12 2.12 0 01-3-3l6.91-6.91a6 6 0 017.94-7.94l-3.76 3.76z"/></svg>` },
  { title: 'Talent Discovery & Development', description: 'Identifying and nurturing the unique artistic, athletic, and creative gifts of young people through structured development pathways and showcases.',                               icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>` },
  { title: 'Youth Skilling Initiative',      description: 'Entrepreneurship, digital literacy, financial management, and life skills training to prepare youth for the modern economy and self-reliance.',                                    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M2 20h.01M7 20v-4M12 20v-8M17 20V8M22 4l-5 5-4-4-6 6"/></svg>` },
  { title: 'Sensitization Campaigns',        description: 'Community-wide programs addressing health, rights, civic responsibility, and social issues, creating informed and engaged young citizens.',                                         icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75"/></svg>` },
  { title: 'Mentorship & Leadership',        description: 'Structured mentorship linking youth with experienced professionals and community leaders who guide, inspire, and model excellence.',                                              icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="12" cy="12" r="10"/><path d="M12 8v4l3 3"/></svg>` },
  { title: 'Community Outreach',             description: 'Grassroots engagement in schools, churches, villages, and urban centres — taking our programs directly to those who need them most.',                                            icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>` },
]
